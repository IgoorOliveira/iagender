...
urlpatterns = [
    ...
    path('operating_days/<str:username>/<str:service>/<int:year>/<int:month>', views.get_operating_days, name="operating_days"),
    ...
    path('user/<str:username>', views.page_hours, name="get-date")
